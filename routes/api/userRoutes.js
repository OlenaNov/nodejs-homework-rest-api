...
const { signup, login, getMe, logout, updateAvatar, updatePassword, forgotPassword, resetPassword, verification, reVerification } = require('../../controllers/userController');
